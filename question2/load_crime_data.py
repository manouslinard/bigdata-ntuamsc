...
crime_df_merged = crime_df1.unionByName(crime_df2)

# Save the merged DataFrame as one Parquet
crime_df_merged.write.mode("overwrite").parquet(output_dir + "crime_10_25/")

print(f"Data saved as Parquet to {output_dir}crime_10_25/")
